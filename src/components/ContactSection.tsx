...
const bullets = [
  "Pre-verified Golden Visa eligible properties in Greece",
  "AI-powered self-assessment platform for independent property analysis",
  "Full Golden Visa support from property investment to residence permit approval",
];

const ContactSection = () => (
  <section id="contact" className="relative overflow-hidden bg-background py-16 sm:py-28" aria-label="Start Your Greek Golden Visa Application">
      ...
      <ScrollReveal>
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-5 py-2 text-sm font-semibold text-primary">
            <Sparkles className="h-4 w-4" /> Start Your Golden Visa Application
          </div>
          ...
          <p className="mx-auto mt-4 max-w-lg text-muted-foreground text-center text-sm">
            Connect with our Greek Golden Visa experts on WhatsApp for instant guidance on €250K property investment and EU residency.
          </p>
