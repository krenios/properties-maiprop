...
<section className="relative flex min-h-screen flex-col justify-end overflow-hidden">
    ...
    <div className="relative z-10 container mx-auto px-6 pb-10 pt-32">
      ...
      <p className="mt-6 max-w-xl text-base sm:text-lg text-muted-foreground text-justify">EU residency through €250K+ Greek real estate investments. <AI-powered platform for independent assessment.
