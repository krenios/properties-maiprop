...
const HeroSection = () => (
  <section className="relative flex min-h-screen flex-col justify-end overflow-hidden" aria-label="Greek Golden Visa Hero">
    {/* Background image */}
    <div className="absolute inset-0">
      <img
        src="https://images.unsplash.com/photo-1555993539-1732b0258235?w=1920&q=80"
        alt="Acropolis Athens Greece - Golden Visa property investment destination"
    ...
    <div className="relative z-10 container mx-auto px-6 pb-10 pt-32">
      <span className="mb-4 inline-block rounded-full border border-primary/40 bg-primary/10 px-5 py-1.5 text-xs font-semibold uppercase tracking-widest text-primary backdrop-blur-sm">
        Greek Golden Visa Program | EU Residency Through Real Estate Investment
      </span>
      ...
      <p className="mt-6 max-w-xl text-base sm:text-lg text-muted-foreground text-justify">
        EU residency through €250K+ Greek real estate investments. Buy Golden Visa eligible properties in Athens, Thessaloniki, and the Greek islands.
        <br /> AI-powered platform for independent property assessment and due diligence.
      </p>
