...
const HeroSection = () => {
  ...
  <section className="relative flex min-h-screen flex-col justify-end overflow-hidden">
    ...
    <div className="absolute inset-0">
      <img
        src="https://images.unsplash.com/photo-1555993539-1732b0258235?w=800&q=30&fm=webp"
        srcSet="https://images.unsplash.com/photo-1555993539-1732b0258235?w=480&q=25&fm=webp 480w, https://images.unsplash.com/photo-1555993539-1732b0258235?w=800&q=30&fm=webp 800w, https://images.unsplash.com/photo-1555993539-1732b0258235?w=1440&q=35&fm=webp 1440w"
        sizes="100vw"
