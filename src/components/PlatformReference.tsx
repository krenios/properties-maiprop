              ...
              <ScrollReveal>
                ...
                >
                  ...
                  <div className={`relative ${p.reverse ? "[direction:ltr]" : ""}`}>
                    {/* Glow behind browser */}
                    <div
                      className={`pointer-events-none absolute -inset-6 rounded-3xl blur-[60px] opacity-20 ${p.reverse ? "bg-secondary" : "bg-primary"}`}
                    />
                    ...
                    <div className="relative rounded-xl overflow-hidden border border-border/50 shadow-2xl bg-[hsl(var(--card))]">
                      ...
                      <div className="overflow-hidden">
                        <img src={p.image} alt={p.imageAlt} className="w-full h-auto block" loading="lazy" />
                      </div>
                    </div>
                  </div>
                </div>
