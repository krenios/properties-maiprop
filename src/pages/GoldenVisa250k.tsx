    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden pt-32 pb-20">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <span className="mb-4 inline-block rounded-full border border-primary/40 bg-primary/10 px-5 py-1.5 text-xs font-semibold uppercase tracking-widest text-primary">
            {t("Pre-Verified Investment Properties")}
          </span>
          ...
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            {t("Hand-picked, pre-verified properties in Athens, Piraeus, Glyfada, and the Athenian Riviera — each qualifying for the")} <strong className="text-foreground">{t("Greek Golden Visa program")}</strong> {t("starting at €250,000. All properties are renovated and rental-ready.")}
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <Button size="lg" className="rounded-full px-8 gap-2" onClick={() => openWithLocation("250k-properties")}>
              {t("Request Property Info")} <ArrowRight className="h-4 w-4" />
            </Button>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <h2 className="mb-2 text-2xl font-bold">{t("Available Investment Properties")}</h2>
          <p className="mb-10 text-muted-foreground">{t("All listings are pre-verified, Golden Visa eligible, and managed by mAI Investments.")}</p>
          ...
          {!loading && properties.length === 0 && (
            <div className="text-center py-20 text-muted-foreground">
              <p>{t("No properties currently available.")} <button className="text-primary underline" onClick={() => openWithLocation("250k-properties")}>{t("Contact us")}</button> {t("for off-market listings.")}</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="py-16 bg-background/50">
        <div className="container mx-auto max-w-4xl px-6">
          <h2 className="mb-8 text-2xl font-bold">{t("Why These Properties Qualify for the Golden Visa")}</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <h2 className="mb-8 text-2xl font-bold text-center">{t("Learn More")}</h2>
          <div className="grid gap-4 sm:grid-cols-2 max-w-2xl mx-auto">
            <Link to="/greek-golden-visa/" className="group rounded-xl border border-border bg-background/40 p-6 hover:border-primary/40 transition-all">
              <h3 className="font-semibold group-hover:text-primary transition-colors">{t("Greek Golden Visa Guide")}</h3>
              <p className="mt-1 text-xs text-muted-foreground">{t("Full overview of the program, benefits, and process.")}</p>
            </Link>
            <Link to="/greek-golden-visa-requirements/" className="group rounded-xl border border-border bg-background/40 p-6 hover:border-primary/40 transition-all">
              <h3 className="font-semibold group-hover:text-primary transition-colors">{t("Requirements & Documents")}</h3>
              <p className="mt-1 text-xs text-muted-foreground">{t("Eligibility checklist and full document requirements.")}</p>
            </Link>
          </div>
        </div>
      </section>
