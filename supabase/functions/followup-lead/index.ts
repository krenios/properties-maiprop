...
<<<<<<< HEAD
          ...
          CALENDLY_URL
=======
          `<p style="margin:0 0 8px;color:#3d3529;font-size:15px;line-height:1.7;">Hi ${firstName},</p>
           <p style="margin:0 0 8px;color:#3d3529;font-size:15px;line-height:1.7;">We wanted to follow up on your Golden Visa inquiry. Our team has curated a selection of properties that match your investment profile.</p>
           <p style="margin:0;color:#3d3529;font-size:15px;line-height:1.7;">We'd love to schedule a call — reply to this email or visit our website.</p>
           <p style="margin:12px 0 0;color:#3d3529;font-size:15px;line-height:1.7;">Warm regards,<br/>The mAI Prop Team</p>`,
          "Browse Our Portfolio →",
          `${SITE_URL}/#opportunities`
>>>>>>> f628d14 (Align lead email templates with brand visuals and readability.)
        ),
      };
    }
